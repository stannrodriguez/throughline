...
const ENERGY: EntryMeta[] = [
  ...
  E('the-sail', 'The sail', '−3500', 'I', 'energy',
    'A sail moves a loaded hull with no rower aboard, for as long as the wind holds.'),
  E('the-bloomery-furnace', 'The bloomery furnace', '−1200', 'II', 'energy',
    'Charcoal at 1,250° pulls iron out of common ore without ever melting it.'),
  E('the-rotary-quern', 'The rotary quern & animal mill', '−300', 'II', 'energy',
    'One animal turning a millstone grinds the grain that took several people a day by hand.'),
  E('the-waterwheel', 'The waterwheel, everywhere', '500', 'III', 'energy',
    'A single mill wheel delivers two to three horsepower, day and night, for the cost of upkeep.'),
  E('the-horse-collar', 'The horse collar', '900', 'III', 'energy',
    'Shifting the load from the windpipe to the shoulders raises a horse’s pulling power three- to fourfold.'),
  E('the-windmill', 'The windmill', '1180', 'IV', 'energy',
    'Power where no river runs: Dutch mills drain polders no waterwheel could reach.'),
  ...
  E('high-pressure-steam', 'High-pressure steam', '1802', 'VII', 'energy',
    'Steam above atmospheric pressure does the same work in a smaller cylinder, light enough to carry itself.'),
  E('the-oil-well', 'The oil well & refinery', '1859', 'VIII', 'energy',
    'Refined oil holds about half again as much energy per kilogram as coal, and flows down a pipe.'),
  E('the-dynamo', 'The dynamo', '1867', 'VIII', 'energy',
    'A coil spun in a magnetic field turns motion into current that can be sent down a wire.'),
  E('filament-lamp', 'Filament lamp', '1879', 'IX', 'energy',
    'A carbon filament in a vacuum burns for over a thousand hours; a candle lasts an evening.'),
  E('the-grid', 'The grid', '1882', 'IX', 'energy',
    'Pearl Street station lights four hundred lamps from six blocks away.'),
  E('internal-combustion', 'Internal combustion', '1886', 'IX', 'energy',
    'Burning the fuel inside the cylinder removes the boiler, and the engine fits under a carriage seat.'),
  E('the-gas-turbine', 'The gas turbine', '1939', 'X', 'energy',
    'Continuous burning rather than separate strokes: enough power per kilogram to lift an aircraft.'),
  ...
  E('the-photovoltaic-cell', 'The photovoltaic cell', '1954', 'XI', 'energy',
    'Bell Labs’ silicon cell turns 6 percent of the sunlight falling on it into current, with no moving part.'),
  E('the-lithium-battery', 'The lithium battery', '1985', 'XI', 'energy',
    'Lithium holds several times the energy per kilogram of lead-acid, in a cell that fits a pocket.'),
  E('grid-scale-storage', 'Grid-scale storage', '2015', 'XII', 'energy',
    'Batteries measured in hundreds of megawatt-hours let a grid store power at noon and sell it at dusk.'),
...
const MATERIALS: EntryMeta[] = [
  E('fired-pottery', 'Fired pottery', '−7000', 'I', 'materials',
    'Fired at 900°, clay changes chemically into a solid that water cannot soften again.'),
  E('the-loom', 'The loom', '−5000', 'I', 'materials',
    'Crossing warp and weft turns loose fibre into a sheet that holds its shape under tension.'),
  E('bronze-casting', 'Bronze casting', '−1500', 'II', 'materials',
    'One part tin to nine of copper: harder than either, and molten at a temperature a kiln can reach.'),
  E('bloomery-iron', 'Bloomery iron', '−1200', 'II', 'materials',
    'Iron ore lies under most of the world; the tin that bronze needs lies under very little of it.'),
  E('paper', 'Paper', '105', 'III', 'materials',
    'Rag and bark, pulped and dried into sheets: a writing surface cheap enough to use for drafts.',
  ...
  E('the-blast-furnace', 'The blast furnace', '1350', 'IV', 'materials',
    'Water-driven bellows hold the furnace at 1,500°, past iron’s melting point, and the metal can be poured.',
    [{ thread: 'energy', justification: 'water power is what buys the extra 150°' }]),
  E('type-metal', 'Type metal', '1450', 'V', 'materials',
    'Lead, tin and antimony cast a letter that holds its dimensions as it cools, so every impression matches.',
  ...
  E('coke-smelted-iron', 'Coke-smelted iron', '1763', 'VII', 'materials',
    'Coke replaces charcoal, and the furnace moves from the woodland to the coalfield.',
  ...
  E('crucible-steel', 'Crucible steel', '1770', 'VII', 'materials',
    'Steel melted in a sealed crucible comes out uniform in composition through the whole ingot.'),
  E('wilkinsons-boring-machine', "Wilkinson's boring machine", '1774', 'VII', 'materials',
    'A cylinder 130 centimetres across, bored true to the thickness of an old shilling.'),
  ...
  E('portland-cement', 'Portland cement', '1824', 'VIII', 'materials',
    'Limestone and clay burned together give a powder that sets hard, and sets under water.'),
  ...
  E('electric-arc-furnace', 'Electric-arc furnace', '1900', 'IX', 'materials',
    'An electric arc reaches 3,500°, roughly two thousand degrees above anything a fuel flame holds.'),
  ...
  E('tungsten-carbide', 'Tungsten carbide', '1927', 'IX', 'materials',
    'A carbide tip cuts steel several times faster than a hardened-steel tool can, without softening.'),
  E('nylon-and-polymers', 'Nylon & the polymers', '1935', 'X', 'materials',
    'A polymer specified on paper before it existed, then drawn into a fibre finer than silk.'),
  E('penicillin-at-scale', 'Penicillin, fermented at scale', '1943', 'X', 'materials',
    'Deep-tank fermentation raises penicillin output from milligrams in a dish to billions of units a month.'),
  ...
  E('lithium-ion-chemistry', 'Lithium-ion chemistry', '1991', 'XII', 'materials',
    'Ions slot in and out of a layered electrode instead of dissolving it, so the cell survives hundreds of cycles.',
...
const INFORMATION: EntryMeta[] = [
  E('writing', 'Writing', '−3200', 'I', 'information',
    'Accounts pressed into clay outlast everyone who witnessed the transaction.'),
  E('the-alphabet', 'The alphabet', '−1050', 'I', 'information',
    'Twenty-two signs replace a script of several hundred, and learning to write takes weeks rather than years.'),
  ...
  E('movable-type', 'Movable type', '1450', 'V', 'information',
    'A press turns out hundreds of identical copies a day, still carried by a rider making 200 km.',
  ...
  E('electric-telegraph', 'The electric telegraph', '1844', 'VIII', 'information',
    'A message crosses two hundred kilometres in the time it takes to tap it out.'),
  E('telephone', 'The telephone', '1876', 'VIII', 'information',
    'The wire carries the voice itself, so nobody has to encode the message or decode it at the far end.'),
  E('radio', 'Radio', '1901', 'IX', 'information',
    'Marconi’s signal crosses 3,500 kilometres of Atlantic in 1901 with no wire under it.'),
  ...
  E('deep-learning', 'Deep learning', '2012', 'XII', 'information',
    'AlexNet cuts the image-recognition error rate from 26 to 15 percent by learning from examples rather than rules.'),
];
