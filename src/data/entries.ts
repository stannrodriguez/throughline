...
const ENERGY: EntryMeta[] = [
  ...
  E('newcomen-engine', 'The Newcomen engine', '1712', 'VI', 'energy',
    'The atmosphere does the work of fifty horses. The only energy stop this period — the hinge of the whole road.',
...
const INFORMATION: EntryMeta[] = [
  ...
  E('telescope', 'The telescope', '1608', 'VI', 'information',
    "One lens grind pointed up. Jupiter's moons, and Earth stops being the center of anything."),
  E('microscope', 'The microscope', '1665', 'VI', 'information',
    'The same grind pointed down. Disease gets a visible cause two centuries before anyone believes it.'),
  E('pendulum-clock', 'The pendulum clock', '1656', 'VI', 'information',
    'Period depends only on length. Clock error falls from fifteen minutes a day to fifteen seconds.'),
  E('barometer-and-vacuum-pump', 'The barometer & vacuum pump', '1643', 'VI', 'information',
    'Air has weight; the vacuum exists. The measurement is information — the void it proves becomes an engine part.',
  ...
  E('marine-chronometer', 'The marine chronometer', '1761', 'VI', 'information',
    'Longitude is just time. H4 crosses the Atlantic and knows where it is to two kilometers.'),
